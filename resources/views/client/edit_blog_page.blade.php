                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                <h6><i class="material-icons me-2 ">edit</i> Edit Blog</h6>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form role="form" class="text-start col-md-12"
                                    action="{{ route('client.edit.blog.post') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="container text-center">
                                            <img src="{{ $blog->file }}" class="img-thumbnail mb-2" alt="..."
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="url_link" required
                                                    value="{{ old('url_link',$blog->url_link) }}" placeholder="Url Link"
                                                    id="url">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <textarea class="form-control" rows="10" name="short_about" required
                                                    ...
                                                    id="sa">{{ old('short_about',$blog->short_about) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <textarea class="form-control" rows="10" name="blog_seo_title" required
                                                    ...
                                                    id="seot">{{ old('blog_seo_title',$blog->blog_seo_title) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <textarea class="form-control" rows="5" name="blog_seo_description"
                                                    required placeholder="Seo Description"
                                                    id="seo">{{ old('blog_seo_description',$blog->blog_seo_description) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="file" class="form-control" rows="5" name="file"
                                                    value="{{ old('file') }}" accept=".jpg,.jpeg,.svg,.webp,.png"
                                                    id="th" />
                                            </div>
                                            @if ($errors->has('file'))
                                            <p class=" p-0 m-0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="date" class="form-control" rows="5" name="date" required
                                                    value="{{ old('date',$blog->date) }}" id="date" />
                                            </div>
                                            @if ($errors->has('date'))
                                            <p class=" p-0 m-0">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch ps-0">
                                                <input class="form-check-input ms-auto" type="checkbox"
                                                    id="flexSwitchCheckDefault" name="status" @if ($blog->status==1)
                                                checked
                                                @endif >
