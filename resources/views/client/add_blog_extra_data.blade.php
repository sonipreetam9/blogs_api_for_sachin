...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                <h6><i class="material-icons me-2 ">add_to_queue</i> Add Blog Extra Data</h6>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form role="form" class="text-start col-md-12"
                                    action="{{ route('client.add.blog.extra.data.post') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="heading" required
                                                    value="{{ old('title') }}" placeholder="Heading" autofocus
                                                    id="heading">
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <textarea class="form-control" id="summernote" rows="20" name="data"
                                                    required placeholder="Seo Description"
                                                    id="seo">{{ old('data') }}</textarea>
                                            </div>
                                            @if ($errors->has('data'))
                                            <p class=" p-0 m-0">
        ...
        @else
        @foreach ($extraBlogs as $data )
        @php
            $i++;
            $decode_data=base64_decode($data->bdata);
        @endphp
        <div class="row mb-4 mt-4">
            <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-lg-12 col-12 d-flex justify-content-between">
                                ...
                                <h6 class="d-flex p-0"><a href="{{ route('client.edit.blog.extra.data.page',['blog_id'=>$id,'id'=>$data->id]) }}" class=" p-0"><i class="material-icons me-4 text-success">edit</i> </a> <form  action="{{ route('client.delete.extra.blog.data') }}" method="POST" onsubmit="return confirmDelete()">
                                    @csrf
                                    <input type="hidden" name="blog_id" value="{{ $id }}">
                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                    <button type="submit" class="btn btn-link p-0 mt-0" style="border: none; background: none;">
                                        <i type="submit" class="material-icons text-danger m-0">delete</i>
                                    </button>
                                </form>

                                <script>
                                    function confirmDelete() {
                                        return confirm('Are you sure you want to delete this blog data?');
                                    }
                                </script>
                                 </h6>
                            </div>
