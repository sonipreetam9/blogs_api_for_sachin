                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                <h6><i class="material-icons text-sm me-2">edit</i> Edit Client</h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <form role="form" class="text-start col-md-12"
                                    action="{{ route('admin.edit.client.post',['clientId'=>$client->id]) }}"
                                    method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="name" required
                                                    value="{{ $client->name }}" placeholder="Name" autofocus>
                                            </div>
                                            @if ($errors->has('name'))
                                            <p class=" p-0 m-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="package" required
                                                    value="{{ $client->package }}" placeholder="Package">

                                            </div>
                                            @if ($errors->has('package'))
                                            <p class=" p-0 m-0">
                                                <li class="error">{{ $errors->first('package') }}</li>
                                            </p>
                                            @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="website_link" required
                                                    value="{{ $client->website_link }}" placeholder="Webisite Link">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-outline my-3 col-md-3">
                                                <input type="text" class="form-control" name="api_link" required
                                                    value="{{ $client->api_link }}" placeholder="Api Link">
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch ps-0">
                                                <input class="form-check-input ms-auto" type="checkbox"
                                                    id="flexSwitchCheckDefault" name="status" @if ($client->status==1)
                                                checked
                                                @endif >
