    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('client.dashboard') }}"
                ...
                <span class="ms-1 font-weight-bold text-white">Client Dashboard</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white @if($active=="add-blog") active @endif " href=" {{
                        route('client.add.blog') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white @if($active=="blog-list") active @endif" href="{{
                        route('client.blog.list') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">view_list</i>
                        </div>
                        <span class="nav-link-text ms-1">Blog List</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('client.logout') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
